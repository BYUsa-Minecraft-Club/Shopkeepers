...
public class ShulkerCustomizations {
    ...
    public static List<ShopkeeperCustomization<ShulkerEntity>> getShulkerCustomizations(ShulkerEntity shulker) {
        List<ShopkeeperCustomization<ShulkerEntity>> customizations = new ArrayList<>();
    ...
    private record ShulkerColorCustomization(DyeColorWithNone color) implements ShopkeeperCustomization<ShulkerEntity> {
        ...
        @Override
        public ShopkeeperCustomization<ShulkerEntity> setNext(ShulkerEntity shopkeeper) {
    ...
    private record ShulkerAttachedFaceCustomization(Direction direction) implements ShopkeeperCustomization<ShulkerEntity> {
    ...
    private record ShulkerPeekHeightCustomization(PeekHeight peekHeight) implements ShopkeeperCustomization<ShulkerEntity> {
