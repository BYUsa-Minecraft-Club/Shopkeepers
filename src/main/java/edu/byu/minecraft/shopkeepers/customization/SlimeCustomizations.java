...
public class SlimeCustomizations {
    public static List<ShopkeeperCustomization<SlimeEntity>> getSlimeCustomizations(SlimeEntity entity) {
        List<ShopkeeperCustomization<SlimeEntity>> customizations = new ArrayList<>();
        customizations.add(new SlimeSizeCustomization(entity.getSize()));
        return customizations;
    }

    private record SlimeSizeCustomization(int size) implements ShopkeeperCustomization<SlimeEntity> {
