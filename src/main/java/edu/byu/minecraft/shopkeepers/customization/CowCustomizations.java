...
public class CowCustomizations {
    public static List<ShopkeeperCustomization<CowEntity>> getCowCustomizations(CowEntity entity) {
        List<ShopkeeperCustomization<CowEntity>> customizations = new ArrayList<>();
        customizations.add(new CowVariantCustomization(entity));
        return customizations;
    }

    private record CowVariantCustomization(Variant variant)
            implements ShopkeeperCustomization<CowEntity> {
